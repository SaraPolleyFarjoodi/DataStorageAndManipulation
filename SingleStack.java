...
public class SingleStack<T> extends SingleLink<T> {
	...
	while ((left.front != null) && (right.front != null)) {
	    this.MoveTopToTop(left);
	    this.MoveTopToTop(right);
	}
    ...
    /**
     * private helper method for combine
     * 
     * @param source
     */
    private void MoveTopToTop(SingleStack<T> source) {
	...
	SingleNode new_node = new SingleNode(datum, this.front);
	this.front = new_node;
